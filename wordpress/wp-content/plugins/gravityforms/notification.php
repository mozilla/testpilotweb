...
Class GFNotification{
    public static function notification_page($form_id){
        ...
        <script type="text/javascript" src="<?php echo GFCommon::get_base_url()?>/js/forms.js"></script>
        ...
        function GetFieldValues(fieldId, selectedValue, labelMaxCharacters){
            ...
            for(var i=0; i<field.choices.length; i++){
                ...
                str += "<option value='" + field.choices[i].value.replace("'", "&#039;") + "' " + selected + ">" + TruncateMiddle(field.choices[i].text, labelMaxCharacters) + "</option>";
            }
